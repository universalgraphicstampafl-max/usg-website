...
const EXTERIOR_HOTSPOTS: Hotspot[] = [
  { id: "pylon", cat: "Pylon", title: "Roadside Pylon Sign", loc: "Lot entrance", pos: [-14, 9.8, 9], desc: "The tall freestanding sign that pulls drivers off the road — fuel pricing, brand marks, and promotions visible from a distance.", usg: "USG fabricates and installs illuminated pylon faces and price-pole inserts, surveyed to your exact cabinet dimensions.", img: `${IMG}/22-newport-marlboro-pylons.webp` },
  { id: "canopy", cat: "Canopy", title: "Canopy Fascia Branding", loc: "Fuel canopy", pos: [-6, 5.6, 11.8], desc: "The illuminated band wrapping the fuel canopy — the single most visible brand surface on the whole site.", usg: "USG fabricates canopy fascia panels and brand bands, color-matched and weather-rated for the pump island.", img: `${IMG}/23-storefront-vinyl-lettering.webp` },
  { id: "pump", cat: "Gas Pump", title: "Pump Topper Graphics", loc: "Fuel island", pos: [-1.8, 3.0, 8.5], desc: "High-dwell-time advertising right at the pump — drivers stare at this for 3-5 minutes per fill.", usg: "USG produces weatherproof pump-topper inserts and dispenser wraps that snap into standard frames.", img: `${IMG}/10-gas-pump-celsius-topper.webp` },
  { id: "window", cat: "Storefront", title: "Window Clings", loc: "Storefront glass", pos: [-1.2, 2.6, 4.7], desc: "Promotional clings and price callouts on entrance doors and front glass — the last message before a customer walks in.", usg: "USG prints removable static and adhesive clings, die-cut to any shape, with easy seasonal swap-out.", img: `${IMG}/07-storefront-window-cling.webp` },
  { id: "fascia", cat: "Building", title: "Building ID & Stripe Band", loc: "Storefront parapet", pos: [-2, 6.5, 4.7], desc: "The brand identity band and channel-letter store ID across the top of the building.", usg: "USG produces channel letters, raceways, and fascia brand bands to franchise spec.", img: `${IMG}/02-convenience-storefront.webp` },
  { id: "aframe", cat: "A-Frame", title: "Sidewalk A-Frame", loc: "Entrance walkway", pos: [6.5, 2.0, 5.4], desc: "Portable sidewalk boards that capture foot traffic with daily specials.", usg: "USG supplies durable A-frame hardware with printed, swappable insert panels.", img: `${IMG}/18-brunch-a-frame.webp` },
  { id: "flag", cat: "Flag", title: "Feather Flags", loc: "Lot perimeter", pos: [-11, 3.8, 5.5], desc: "Tall feather and blade flags that create motion and draw eyes from the road.", usg: "USG prints feather flags in multiple formats with poles, bases, and ground stakes.", img: `${IMG}/20-three-flag-formats.webp` },
];
const INTERIOR_HOTSPOTS: Hotspot[] = [
  { id: "beercave_h", cat: "Cooler Graphics", title: "Beer Cave Header", loc: "Walk-in cooler entrance", pos: [8.5, 4.0, -4.5], desc: "The lit header band above the walk-in beer cave — a category destination cue visible across the store.", usg: "USG builds illuminated beer-cave headers and entry surrounds, sized to the opening.", img: `${IMG}/03-corona-beer-cave.webp` },
  { id: "beercave_d", cat: "Cooler Graphics", title: "Beer Cave Door Decals", loc: "Walk-in cooler doors", pos: [8.3, 2.2, -3], desc: "Full-height decals on the glass cave doors that merchandise brands and promos.", usg: "USG produces door-sized cling and adhesive decals, planogram-accurate, easy to swap.", img: `${IMG}/09-cooler-doors-graphics.webp` },
  { id: "reachin", cat: "Cooler Graphics", title: "Reach-In Cooler Doors", loc: "Beverage wall", pos: [8.3, 3.0, 3], desc: "The wall of reach-in glass doors — turned into branded merchandising with full-door graphics.", usg: "USG prints reach-in door wraps and handle-rail signage across the cooler run.", img: `${IMG}/09-cooler-doors-graphics.webp` },
  { id: "slurpee", cat: "Beverage", title: "Slurpee Machine Topper", loc: "Frozen drink station", pos: [-5, 3.4, -6.5], desc: "The iconic frozen-drink machine — topper graphics, flavor tags, and the Slurpee brand crown.", usg: "USG produces machine toppers, flavor-strip inserts, and surround graphics for frozen and dispensed drinks.", img: `${IMG}/12-iced-coffee-dispenser.webp`, placeholder: true },
  { id: "fountain", cat: "Beverage", title: "Big Gulp Fountain", loc: "Fountain drink station", pos: [-1, 3.2, -6.5], desc: "The Big Gulp fountain wall — cup-size callouts, flavor branding, and overhead category signage.", usg: "USG prints fountain valance graphics, cup-size guides, and dispenser branding.", img: `${IMG}/12-iced-coffee-dispenser.webp`, placeholder: true },
  { id: "coffee", cat: "Beverage", title: "Coffee Bar Signage", loc: "Hot beverage station", pos: [3.5, 3.2, -6.5], desc: "The self-serve coffee bar — overhead menu, flavor tags, and price callouts.", usg: "USG produces coffee-bar valances, menu panels, and condiment-station signage.", img: `${IMG}/12-iced-coffee-dispenser.webp`, placeholder: true },
  { id: "grill", cat: "Menu Board", title: "Roller Grill / Hot Food Menu", loc: "Foodservice counter", pos: [7, 3.8, -6.3], desc: "The hot-food program signage — roller grill menus, combo deals, and LTO callouts.", usg: "USG designs and prints hot-food menus and provides modular rail systems for fast updates.", img: `${IMG}/14-hot-dog-combo-signs.webp` },
  { id: "suspended", cat: "Menu Board", title: "Suspended Category Signage", loc: "Ceiling, center store", pos: [0, 4.6, -1], desc: "Ceiling-hung category and wayfinding signage that floats above the aisles.", usg: "USG fabricates suspended sign blades with hanging hardware rated for your ceiling type.", img: `${IMG}/19-suspended-menu-board.webp` },
  { id: "shelf", cat: "Shelf Talker", title: "Gondola Shelf Talkers", loc: "Center aisles", pos: [0, 1.7, 3.6], desc: "Price and promo flags clipped to shelf edges — the workhorse of in-aisle merchandising.", usg: "USG prints shelf-edge talkers, wobblers, and channel strips in bulk with quick reorder.", img: `${IMG}/21-coke-pepsi-shelf-talkers.webp` },
  { id: "endcap", cat: "Floor Display", title: "Endcap Floor Display", loc: "Aisle endcap", pos: [-3, 2.0, 4.4], desc: "Freestanding point-of-purchase displays that command floor space at endcaps.", usg: "USG produces corrugated and permanent floor displays, shipped flat or pre-assembled.", img: `${IMG}/16-vuex-pop-floor-display.webp` },
  { id: "checkout", cat: "Counter", title: "Checkout & Impulse Signage", loc: "Front counter", pos: [-8.4, 2.2, 5], desc: "The counter zone — impulse racks, register toppers, and age-verification signage.", usg: "USG prints counter mats, register toppers, impulse-rack headers, and compliance signage.", img: `${IMG}/15-karma-poster-frame.webp`, placeholder: true },
  { id: "backbar", cat: "Tobacco", title: "Tobacco Backbar", loc: "Behind front counter", pos: [-9.5, 3.6, 5], desc: "The regulated tobacco fixture behind the register — pricing, brand headers, and compliance.", usg: "USG produces backbar headers, price channels, and FDA-compliant tobacco signage.", img: `${IMG}/06-tobacco-marlboro.webp` },
  { id: "lottery", cat: "Counter", title: "Lottery & ATM Signage", loc: "Front counter end", pos: [-7.5, 2.0, 6.5], desc: "Lottery dispensers, jackpot callouts, and ATM/financial-services signage at the counter.", usg: "USG prints lottery toppers, jackpot inserts, and ATM/service decals.", img: `${IMG}/16-vuex-pop-floor-display.webp`, placeholder: true },
  { id: "floorgfx", cat: "Floor Display", title: "Floor Graphics", loc: "Main aisle", pos: [0, 0.4, 4.5], desc: "Walk-on floor decals for wayfinding, promotions, and brand moments underfoot.", usg: "USG prints anti-slip floor graphics rated for high-traffic retail environments.", img: `${IMG}/16-vuex-pop-floor-display.webp`, placeholder: true },
];
