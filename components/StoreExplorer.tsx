...
const EXTERIOR_HOTSPOTS: Hotspot[] = [
  ...
  { id: "window", cat: "Storefront", title: "Window Signs", loc: "Storefront glass", pos: [4.6, 3.55, -7.5], desc: "Promotional clings and price callouts on entrance doors and front glass \u2014 the last message before a customer walks in.", usg: "USG prints removable static and adhesive clings, die-cut to any shape, with easy seasonal swap-out.", img: `${IMG}/storefront-promo-window-cling.webp`, imgs: [`${IMG}/storefront-promo-window-cling.webp`, `${IMG}/storefront-promo-window-cling2.webp`, `${IMG}/storefront-promo-window-cling3.webp`] },
  ...
  { id: "bollard", cat: "Bollard", title: "Triangle Bollard", loc: "Fuel island, between the pumps", pos: [9.75, 2.45, 14.85], desc: "3 sided advertising vehicle that captures the attention of drivers as they make their way from the pump into the store. Advertisements are visible from all directions.", usg: "USG offers easy install bollards that can be customized to any shape and size.", img: "/images/signtypes/panels/bollard-1.webp", imgs: ["/images/signtypes/panels/bollard-1.webp", "/images/signtypes/panels/bollard-2.webp"] },
...
function ExteriorScene() {
  ...
  const iceDecalTex = useSRGB("/images/signtypes/tom-thumb-ice-decal.webp");
  return (
    <group>
      <StationModel />
